...
gameObject
, new
AutoAttackEvaluator.FactionMemberParallelInfo(transform.position,
_factionMember.FactionId)
, (go, value) =>
{
    ...
    {
        AutoAttackEvaluator.FactionMembersInfo.TryRemove(gameObject, out
        _);
    }
}
